...
def test_categorize_success():
    ...
    assert df["success_label"][0] == 0  # Engagement score 100 should be categorized as 0 (since it's not greater than 100)
    ...
    assert df["success_label"][3] == 0  # Engagement score 75 should be categorized as 0
    assert df["success_label"][4] == 1  # Engagement score 150 should be categorized as 1
